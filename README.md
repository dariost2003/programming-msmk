...
| # | Nombre | Tema | Para quien |
|---|--------|------|------------|
| 1 | [Dashboard de Sensores](ejercicio-1-sensores/) | Procesamiento de datos + UI reactiva | Alumnos de hardware |
...
2. Entra en la carpeta de tu ejercicio
3. Lee el `README.md` de tu ejercicio
4. Instala las dependencias: `pip install -r requirements.txt`
5. Ejecuta el starter code para verificar que funciona
6. Empieza a construir lo que se pide
